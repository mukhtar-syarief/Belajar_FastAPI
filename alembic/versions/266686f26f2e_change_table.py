...
def upgrade() -> None:
    ...
    op.create_foreign_key(None, 'user_detail', 'users', ['name'], ['name'], onupdate='CASCADE', ondelete='CASCADE')
    op.create_foreign_key(None, 'user_detail', 'users', ['password'], ['password'])
